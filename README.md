...
6. You can run OpenMAP-T1c !!

# How to download the pretrained model.
You can get the pretrained model from this link.
[Link of pretrained model](https://forms.office.com/r/gu2y08WPK7)

![image](media/Download_pretrained_t1c.png)
...
# FAQ
* **What are the contributions of OpenMAP-T1c?**<br>
...
* **Which atlas is used in OpenMAP-T1c?**<br>
OpenMAP-T1c employs the JHU atlas.

* **Can OpenMAP-T1c be used with 2D imaging data?**<br>
...
* **How much GPU memory do I need to run OpenMAP-T1c?**<br>
